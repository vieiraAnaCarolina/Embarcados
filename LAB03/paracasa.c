...
void config(void){
    ...
    *ponteiro_PCMSK1 |= 0x08;      // Habilita o bit 3 do PCMSK1 (0x6C)

    *ponteiro_PCICR |= 0x02;       // Habilita o bit 1 do PCICR (0x68)
...
void forma_centena(unsigned char digito) {
    ...
    *ponteiro_portc &= ~0x21; // Limpa os bits 0 e 5     (0b00100001)
...
int main (void){
    ...
    while(1){  
        ...
        rpm = ((unsigned long)numero_de_pulsos * 60) / 98;
